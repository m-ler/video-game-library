		...
		<div>
			<div className={inputWrapperStyle}>
				...
				<input
					...
					ref={inputElementRef}
				></input>
				<span data-testid="form-input-label" className={labelStyle}>
					{props.label}
				</span>
			</div>
			{!!errorMessage && (
				<div className="flex items-center gap-x-[5px] my-[5px] animate-[fadeIn_0.3s_ease-out]" data-testid="form-input-error-message">
